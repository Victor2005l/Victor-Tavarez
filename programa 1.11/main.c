...
corresponden a los vertices de una triangulo, calcula su perimetro.

X1, Y1, X2, Y2, X3, Y3, LA1, LA3, y PER: variables de tipo real*/
...
void main (void)
{
    ...
    printf("Ingrese la coordenada del punto P2:");
     ...
     LA2 = sqrt(pow(X2-X3, 2) + pow(Y2-Y3, 2));
      ...
      PER = LA1 + LA2 + LA3;
      printf("\nEl perimetro del triangulo es: %6.3" , PER);}
